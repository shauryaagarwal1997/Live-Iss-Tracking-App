...
if(appState===1){    
    ...
    if(dataInfoA>10 && dataInfoA<120 && dataInfoB>10 && dataInfoB<80){
    ...
    if(dataInfoA>-8 && dataInfoA<10 && dataInfoB>40 && dataInfoB<70){
    ...
    if(score!=1 && score!=2 && score!=3 && score!=4 && score !=5 && score!=6 && dataInfoA>30 && dataInfoA<130 && dataInfoB>-60 && dataInfoB<60){
        textSize(50);
        text("INDIAN OCEAN",displayWidth/2+150,displayHeight/2+70);
        text("--",displayWidth/2+270,displayHeight/2-10);
    }
    if(score!=1 && score!=2 && score!=3 && score!=4 && score !=5 && score!=6 && dataInfoA>130 && dataInfoA<180 && dataInfoB>-60 && dataInfoB<60){
        textSize(50);
        text("PACIFIC OCEAN",displayWidth/2+150,displayHeight/2+70);
        text("--",displayWidth/2+270,displayHeight/2-10);
    }
